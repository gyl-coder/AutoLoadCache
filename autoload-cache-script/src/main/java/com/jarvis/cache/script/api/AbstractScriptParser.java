package com.jarvis.cache.script.api;

import com.jarvis.cache.common.annotation.Cache;
import com.jarvis.cache.common.annotation.CacheDeleteKey;
import com.jarvis.cache.common.annotation.CacheDeleteMagicKey;
import com.jarvis.cache.common.annotation.ExCache;
import com.jarvis.cache.common.type.CacheOpType;
...
public abstract class AbstractScriptParser {
     ...
     * @throws Exception 异常
     */
    public abstract <T> T getElValue(
            String exp,
            Object target,
            Object[] arguments,
            Object retVal,
     ...
     * @throws Exception 异常
     */
    public <T> T getElValue(String keyEL, Object target, Object[] arguments, Class<T> valueType)
            throws Exception {
     ...
     * @throws Exception 异常
     */
    public String getDefinedCacheKey(
            String keyEL, Object target, Object[] arguments, Object retVal, boolean hasRetVal)
            throws Exception {
    ...
    public boolean isCacheable(Cache cache, Object target, Object[] arguments) throws Exception {
        ...
        if (null != arguments
                && arguments.length > 0
                && null != cache.condition()
                && cache.condition().length() > 0) {
     ...
     * @throws Exception 异常
     */
    public boolean isCacheable(Cache cache, Object target, Object[] arguments, Object result)
            throws Exception {
        boolean rv = true;
     ...
     * @throws Exception 异常
     */
    public boolean isCacheable(ExCache cache, Object target, Object[] arguments, Object result)
            throws Exception {
     ...
     * @throws Exception 异常
     */
    public boolean isAutoload(Cache cache, Object target, Object[] arguments, Object retVal)
            throws Exception {
        ...
        if (null != arguments
                && arguments.length > 0
                && null != cache.autoloadCondition()
                && cache.autoloadCondition().length() > 0) {
            autoload =
                    this.getElValue(
                            cache.autoloadCondition(),
                            target,
                            arguments,
                            retVal,
                            true,
     ...
     * @throws Exception 异常
     */
    public boolean isCanDelete(CacheDeleteKey cacheDeleteKey, Object[] arguments, Object retVal)
            throws Exception {
        boolean rv = true;
    ...
    public boolean isCanDelete(
            CacheDeleteMagicKey cacheDeleteKey, Object[] arguments, Object retVal)
            throws Exception {
        boolean rv = true;
        String condition = cacheDeleteKey.condition();
        if (null != condition && condition.length() > 0) {
     ...
     * @throws Exception 异常
     */
    public int getRealExpire(int expire, String expireExpression, Object[] arguments, Object result)
            throws Exception {
        Integer tmpExpire = null;
        if (null != expireExpression && expireExpression.length() > 0) {
            tmpExpire =
                    this.getElValue(expireExpression, null, arguments, result, true, Integer.class);
